  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center">
          ...
          <input className="mx-2 p-1.5" type="text" placeholder="Write A Task" onChange={handleChange} value={newTasks} />
          <button className="bg-green-300 text-white px-4 py-2 rounded-md hover:bg-green-600 ml-0 transition-all" onClick={handleAdd}>Add Task </button>
